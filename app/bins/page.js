...
<option value="ZINKA">ZINKA</option>
          ...
          <div id="novbvbins" className="grid-view mt-6 tablec">
            <table className="items table-auto w-[100%] border-collapse">
              <thead>
                <tr>
          ...
          {currentData.map((item) => (
            ...
            <div className="pagination mt-4 max-w-[285px]">
            <nav>
...
<span className="pagination flex">
      ...
      <FloatingLoader visible={load} message="Sending your request..." />
    </div>
